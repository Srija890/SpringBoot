...
public class TrackRepositoryTest
{
    ...
    public void testSaveTrackFailure(){
        Track testTrack = new Track(103,"Srija","IBM");
        trackRepository.save(track);
        Track fetchTrack = trackRepository.findById(track.getId()).get();
    ...
    public void testGetAllTracks(){
        Track track = new Track(104,"Sweety","GetTracks");
        Track track1 = new Track(105,"Srija","GetTracks");
        trackRepository.save(track);
        trackRepository.save(track1);

        List<Track> list = trackRepository.findAll();
        Assert.assertEquals("Sweety",list.get(0).getName());
        Assert.assertEquals("Srija",list.get(1).getName());
